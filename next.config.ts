 ...
 */
const DEMO_STUBBED = /[\\/]server[\\/](auth-actions|session|catalog-actions|catalog-queries|storefront-queries|company-actions|company-queries|admin-queries|request-actions|request-queries)$/
