...
| `documents` | Договор, счёт, акт: шаблоны, PDF, нумерация, **два пути подписания** | `documents` | deal | 24 + 100 |
...
> | **Подписание документов: УКЭП и бумага** (`docs/11-electronic-signature.md`) | +100 |
> | **Итого к базовым 252** | **+296** |
>
> Новая база 548 ч, с коэффициентом переделок 1,2 — **около 658 часов**.
> При 62 ч/мес это 10,6 месяца чистой работы и **13–16 месяцев календаря**
> против семи по исходному плану.
>
> Решение «делаем всё сразу» принято 27.08.2026, до того как выяснилась цена
> подписания: сто часов вместе с бумажным путём, около трёх месяцев календаря
> одной строкой. Стоит перечитать то решение, зная эту цифру.
