...
| `documents` | Договор, счёт, акт: шаблоны, PDF, нумерация, **электронная подпись** | `documents` | deal | 24 + 56 |
...
> | **Электронная подпись документов** (Q16, условие акционной ставки) | +56 |
> | **Итого к базовым 252** | **+252** |
>
> Новая база 504 ч, с коэффициентом переделок 1,2 — **около 605 часов**.
> При 62 ч/мес это 9,8 месяца чистой работы и 12–14 месяцев календаря
> против семи по исходному плану.
>
> Решение «делаем всё сразу» принято 27.08.2026, до того как выяснилась
> цена электронной подписи. Она добавилась последней и одна стоит
> примерно два месяца календаря — стоит перечитать это решение, зная её.
